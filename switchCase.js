...
class switchCase extends baseElement {
    ...
    <div class="row mb-1">
        <div class="col">
            <div class="tab-content" >
                <div class="tab-pane tab-pane-top fade active show " id="{{modal.id}}_{{ms.no}}_tab1" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab1">
                    <div class="row pr-15">
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary 
                                ...
                                onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="-" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                                title="Click the <b>-</b> symbol then move the variables you want 
                                to separate with <b>-</b>. To insert just <b>-</b>, double click it">
                    ...
                    <div class="row pr-15">
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="log" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="log10" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="log2" onclick="toggleButton(event)"  ondblclick="toFocusedInput(event)"
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                    ...
                    <div class="row pr-15">
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="abs" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="exp" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab2" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab2">
                    ...
                    <div class="row pr-15">
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="isTRUE" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="is.na" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab3" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab3">
                    <div class="row pr-15">
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="round" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="ceiling" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="floor" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="signif" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="gamma" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="lgamma" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="beta" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="lbeta" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="factorial" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                            val="pigamma" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                            data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab4" role="tabpanel"  aria-labelledby="{{modal.id}}_{{ms.no}}_tab4">
                    <div class="row pr-15">
                        <div class="col p-0">
                                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                    val="toupper" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                    data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                    val="tolower" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                    data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="Pad" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="Trim" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="Length" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
                        ...
                        <div class="col p-0">
                            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                                val="Count(matches)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab5" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab5">
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Extract Substring" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Concatenate" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Replace Pattern" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Replace Pattern(ALL)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Extract a Number" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab6" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab6">
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="as.numeric" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="ToCharacter" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="ToFactor" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="ToOrdered" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
                ...
                <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="ToLogical" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="max" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="min" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="mean" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="median" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="sd" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="sum" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                    val="variance" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                    data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="tab-pane tab-pane-top fade" id="{{modal.id}}_{{ms.no}}_tab8" role="tabpanel" aria-labelledby="{{modal.id}}_{{ms.no}}_tab8">
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="runif" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)"
                data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="sample" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="rnorm" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Day of Week" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Day of Month" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Day of Year" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Week of Year" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Month" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Month(decimal)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Quarters" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Year(XXXX)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Year(XX)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Hour(00-12)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Hour(00-23)" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
                    <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                        val="Minutes" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                        data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Secs" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Date from String" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Date Difference" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
            ...
            <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="Numeric to date" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
        ...
        <div class="col p-0">
            <button type="button" class="btn btn-outline-secondary formula-btn w-100 m-0" 
                val="String to date" onclick="toggleButton(event)" ondblclick="toFocusedInput(event)" 
                data-toggle="tooltip" data-html="true" data-placement="top"   
    ...
    canExecute(refToBaseModal) {
        ...
        for (var i = 0 ; i < if_elements.length; i ++) {
            if (if_elements[i].value == "" || if_elements[i].value == undefined )
            {
        ...
        for (var i = 0 ; i < then_elements.length; i ++) {
            if (then_elements[i].value == "" || then_elements[i].value == undefined )
            {
        ...
        for (var i = 0 ; i < else_elements.length; i ++) {
            if (else_elements[i].value == "" || else_elements[i].value == undefined ) 
            {
